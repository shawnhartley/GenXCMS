...
<cfcomponent>
	...
	<cffunction name="googleSitemap" access="remote" output="true" description="
		...
		<cfsavecontent variable="sitemap"><cfoutput><?xml version="1.0" encoding="UTF-8" ?>
		<urlset
      xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"
      xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
      xsi:schemaLocation="http://www.sitemaps.org/schemas/sitemap/0.9
            http://www.sitemaps.org/schemas/sitemap/0.9/sitemap.xsd">
		<cfloop query="qry_view"><cfsilent>
		...
		<priority>#priority[qry_view.depth + 1]#</priority>
		</url>
