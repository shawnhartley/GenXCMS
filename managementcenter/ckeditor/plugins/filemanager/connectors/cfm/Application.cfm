 ...
 *	@copyright	Authors
--->
<cfapplication name="filemanager_#cgi.http_host#" applicationtimeout="#createTimeSpan(1,0,0,0)#" sessionmanagement="yes" clientmanagement="no" />
...
<cffunction name="isAllowed" access="public" returntype="boolean">
	<cfreturn (structKeyExists(cookie, 'ufmanid') AND cookie.ufmanid EQ hash(session.URLToken)) />
</cffunction>